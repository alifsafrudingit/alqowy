            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-10 flex flex-col gap-y-5">
              ...
              <div class="item-card flex flex-row justify-between items-center">
                  ...
                  <div>
                      ...
                      <h3 class="text-indigo-950 text-xl font-bold">{{ $transaction->created_at->isoFormat('ddd, DD MMMM Y') }}</h3>
                      <p class="text-slate-500 text-sm">{{ $transaction->created_at->diffForHumans() }}</p>
                  </div>
                  <div>
