<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
          ...
          {!! __('&raquo; Update &raquo; #') . $course->id . ' &middot; ' . $course->name !!}
        </h2>
    </x-slot>
            ...
            <div class="bg-white overflow-hidden p-10 shadow-sm sm:rounded-lg">
                ...
                <form method="POST" action="{{ route('admin.courses.update', $course) }}" enctype="multipart/form-data">
                    ...
                    <div class="mt-4">
                      ...
                      <x-text-input id="path_trailer" class="block mt-1 w-full" type="text" name="path_trailer" :value="old('name') ?? $course->path_trailer" required autofocus autocomplete="name" />
                    ...
                    <div class="mt-4">
                        ...
                        <select name="category_id" id="category_id" class="py-3 rounded-lg pl-3 w-full border border-slate-300">
                            <option value="{{ $course->category->id }}">Tidak Diubah ({{ $course->category->name }})</option>
                    ...
                    <div class="mt-4">
                        ...
                        <div class="flex flex-col gap-y-5">
                            ...
                            @forelse($course->course_keypoints as $keypoint)
                                <input type="text" class="py-3 rounded-lg border-slate-300 border" value="{{ old('keypoint') ?? $keypoint->name }}" placeholder="Write your copywriting" name="course_keypoints[]">
                            @empty
